...
<div class="tab__box">
        <div class="tab__items">
            ...
            <a class="tab__item" href="{{ route('courses.approvedCourse') }}">دوره های تایید شده</a>
            <a class="tab__item is-active" href="{{ route('courses.unapprovedCourse') }}">دوره های تایید نشده</a>
